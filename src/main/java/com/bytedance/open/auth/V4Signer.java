...
public class V4Signer extends AbstractSigner{
    ...
    private void sign4(com.bytedance.open.model.SignableRequest request, com.bytedance.open.model.Credentials credentials) throws Exception {
    ...
    private String hashedSimpleCanonicalRequestV4(com.bytedance.open.model.SignableRequest request, MedaData meta) throws Exception {
    ...
    private String hashedCanonicalRequestV4(com.bytedance.open.model.SignableRequest request, MedaData meta) throws Exception {
    ...
    private String stringToSignV4(com.bytedance.open.model.SignableRequest request, String hashedCanonReq, MedaData meta) {
    ...
    private String buildAuthHeaderV4(String signature, MedaData meta, com.bytedance.open.model.Credentials credentials) {
    ...
    private byte[] readBody(com.bytedance.open.model.SignableRequest request) throws Exception {
    ...
    private void prepareRequestV4(com.bytedance.open.model.SignableRequest request) {
    ...
    private String timestampV4() {
        DateFormat df = new SimpleDateFormat(com.bytedance.open.util.Const.TimeFormatV4);
        df.setTimeZone(tz);
