...
public abstract class BaseVcloudService implements VcloudService {
    ...
    private com.bytedance.open.model.ServiceInfo serviceInfo;

    private Map<String, com.bytedance.open.model.ApiInfo> apiInfoList;

    private com.bytedance.open.auth.Signer signer;
    ...
    public BaseVcloudService(com.bytedance.open.model.ServiceInfo info, Map<String, com.bytedance.open.model.ApiInfo> apiInfoList) {



        this.serviceInfo = info;
        this.apiInfoList = apiInfoList;
        this.signer = new com.bytedance.open.auth.V4Signer();

        this.httpClient = com.bytedance.open.http.HttpClientFactory.create(new com.bytedance.open.http.ClientConfiguration());

        String accessKey = System.getenv(com.bytedance.open.util.Const.AccessKey);
        String secretKey = System.getenv(com.bytedance.open.util.Const.SecretKey);
    ...
    public String getSignUrl(String api, Map<String, String> query) throws Exception {
        com.bytedance.open.model.ApiInfo apiInfo = apiInfoList.get(api);

        if (apiInfo == null) {
            throw new Exception("相关api不存在");
        }

        List<NameValuePair> mergedNV = mergeQuery(com.bytedance.open.util.Utils.mapToPairList(query), apiInfo.getQuery());

        com.bytedance.open.model.SignableRequest request = new com.bytedance.open.model.SignableRequest();
    ...
    public com.bytedance.open.model.SdkResponse query(String api, Map<String, String> query) {
        ...
        if (apiInfo == null) {
            return new com.bytedance.open.model.SdkResponse(null, 500, new Exception("相关api不存在"));
        }

        com.bytedance.open.model.SignableRequest request = prepareRequest(api, query);
    ...
    public com.bytedance.open.model.SdkResponse post(String api, Map<String, String> query, Map<String, String> form) {
        ...
        List<NameValuePair> mergedForm = mergeQuery(com.bytedance.open.util.Utils.mapToPairList(form), apiInfo.getForm());
        ...
        try {
            ...
            return new com.bytedance.open.model.SdkResponse(null, 500, e);
        }

        return makeRequest(api, request);
    }

    private com.bytedance.open.model.SdkResponse makeRequest(String api, com.bytedance.open.model.SignableRequest request) {
        try {
        ...
        try {
            ...
            if (statusCode >= 300) {
                return new com.bytedance.open.model.SdkResponse(null, statusCode,
                        new Exception(
                                "HTTP Request is not success, Response code is " + response.getStatusLine().getStatusCode()));
            }
            byte[] bytes = EntityUtils.toByteArray(response.getEntity());
            return new com.bytedance.open.model.SdkResponse(bytes, 0, null);
        } catch (Exception e) {
            e.printStackTrace();
            return new com.bytedance.open.model.SdkResponse(null, 500, e);
        }
    ...
    private com.bytedance.open.model.SignableRequest prepareRequest(String api, Map<String, String> query) {
        com.bytedance.open.model.ApiInfo apiInfo = apiInfoList.get(api);
    ...
    public com.bytedance.open.model.ServiceInfo getServiceInfo() {
        return serviceInfo;
    }
    ...
    public Map<String, com.bytedance.open.model.ApiInfo> getApiInfoList() {
        return apiInfoList;
    }

    public com.bytedance.open.auth.Signer getSigner() {
        return signer;
    }
