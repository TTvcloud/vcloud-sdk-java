...
public class V4Signer extends AbstractSigner{
    ...
    private void sign4(com.bytedanceapi.model.SignableRequest request, com.bytedanceapi.model.Credentials credentials) throws Exception {
    ...
    private String hashedSimpleCanonicalRequestV4(com.bytedanceapi.model.SignableRequest request, MedaData meta) throws Exception {
    ...
    private String hashedCanonicalRequestV4(com.bytedanceapi.model.SignableRequest request, MedaData meta) throws Exception {
    ...
    private String stringToSignV4(com.bytedanceapi.model.SignableRequest request, String hashedCanonReq, MedaData meta) {
    ...
    private String buildAuthHeaderV4(String signature, MedaData meta, com.bytedanceapi.model.Credentials credentials) {
    ...
    private byte[] readBody(com.bytedanceapi.model.SignableRequest request) throws Exception {
    ...
    private void prepareRequestV4(com.bytedanceapi.model.SignableRequest request) {
