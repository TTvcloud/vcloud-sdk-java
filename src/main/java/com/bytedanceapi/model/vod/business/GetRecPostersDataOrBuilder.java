...
public interface GetRecPostersDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Vcloud.Models.Vod.GetRecPostersData)
   ...
   */
  java.util.List<com.bytedanceapi.model.vod.business.StoreUriGroup> 
   ...
   * <code>repeated .Vcloud.Models.Vod.StoreUriGroup StoreUriGroups = 1;</code>
   */
  com.bytedanceapi.model.vod.business.StoreUriGroup getStoreUriGroups(int index);
  /**
   * <pre>
   *封面图信息
   * </pre>
   ...
   * <code>repeated .Vcloud.Models.Vod.StoreUriGroup StoreUriGroups = 1;</code>
   */
  java.util.List<? extends com.bytedanceapi.model.vod.business.StoreUriGroupOrBuilder> 
   ...
   * <code>repeated .Vcloud.Models.Vod.StoreUriGroup StoreUriGroups = 1;</code>
   */
  com.bytedanceapi.model.vod.business.StoreUriGroupOrBuilder getStoreUriGroupsOrBuilder(
      int index);
