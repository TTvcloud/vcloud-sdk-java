...
public interface GetVideoInfosDataOrBuilder extends
   ...
   */
  java.util.List<com.bytedanceapi.model.vod.business.VideoInfo> 
   ...
   * <code>repeated .Vcloud.Models.Vod.VideoInfo VideoInfoList = 1;</code>
   */
  com.bytedanceapi.model.vod.business.VideoInfo getVideoInfoList(int index);
  /**
   * <pre>
   *视频信息列表
   * </pre>
   ...
   * <code>repeated .Vcloud.Models.Vod.VideoInfo VideoInfoList = 1;</code>
   */
  java.util.List<? extends com.bytedanceapi.model.vod.business.VideoInfoOrBuilder> 
   ...
   * <code>repeated .Vcloud.Models.Vod.VideoInfo VideoInfoList = 1;</code>
   */
  com.bytedanceapi.model.vod.business.VideoInfoOrBuilder getVideoInfoListOrBuilder(
      int index);
