...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              videoInfoList_ = new java.util.ArrayList<VodVideoInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            videoInfoList_.add(
                input.readMessage(VodVideoInfo.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return VodMedia.internal_static_Vcloud_Models_Vod_VodGetVideoInfosData_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return VodMedia.internal_static_Vcloud_Models_Vod_VodGetVideoInfosData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            VodGetVideoInfosData.class, Builder.class);
  }

  public static final int VIDEOINFOLIST_FIELD_NUMBER = 1;
  private java.util.List<VodVideoInfo> videoInfoList_;
  /**
   * <pre>
   *视频信息列表
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<VodVideoInfo> getVideoInfoListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends VodVideoInfoOrBuilder>
   ...
   */
  @java.lang.Override
  public VodVideoInfo getVideoInfoList(int index) {
   ...
   */
  @java.lang.Override
  public VodVideoInfoOrBuilder getVideoInfoListOrBuilder(
      int index) {
    return videoInfoList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof VodGetVideoInfosData)) {
      return super.equals(obj);
    }
    VodGetVideoInfosData other = (VodGetVideoInfosData) obj;
  ...
  public static VodGetVideoInfosData parseFrom(
  ...
  public static VodGetVideoInfosData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static VodGetVideoInfosData parseFrom(
  ...
  public static VodGetVideoInfosData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static VodGetVideoInfosData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static VodGetVideoInfosData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(VodGetVideoInfosData prototype) {
  ...
  public static final class Builder extends
    ...
    @java.lang.Override
    public VodGetVideoInfosData getDefaultInstanceForType() {
      return VodGetVideoInfosData.getDefaultInstance();
    }

    @java.lang.Override
    public VodGetVideoInfosData build() {
      VodGetVideoInfosData result = buildPartial();
    ...
    @java.lang.Override
    public VodGetVideoInfosData buildPartial() {
      VodGetVideoInfosData result = new VodGetVideoInfosData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof VodGetVideoInfosData) {
        return mergeFrom((VodGetVideoInfosData)other);
      } else {
    ...
    public Builder mergeFrom(VodGetVideoInfosData other) {
      if (other == VodGetVideoInfosData.getDefaultInstance()) return this;
      if (videoInfoListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      VodGetVideoInfosData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (VodGetVideoInfosData) e.getUnfinishedMessage();
    ...
    private void ensureVideoInfoListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        videoInfoList_ = new java.util.ArrayList<VodVideoInfo>(videoInfoList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        VodVideoInfo, VodVideoInfo.Builder, VodVideoInfoOrBuilder> videoInfoListBuilder_;
     ...
     */
    public Builder setVideoInfoList(
        int index, VodVideoInfo.Builder builderForValue) {
      if (videoInfoListBuilder_ == null) {
        ensureVideoInfoListIsMutable();
     ...
     * <code>repeated .Vcloud.Models.Vod.VodVideoInfo VideoInfoList = 1;</code>
     */
    public Builder addVideoInfoList(VodVideoInfo value) {
      if (videoInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addVideoInfoList(
        VodVideoInfo.Builder builderForValue) {
      if (videoInfoListBuilder_ == null) {
        ensureVideoInfoListIsMutable();
    ...
    public Builder addAllVideoInfoList(
        java.lang.Iterable<? extends VodVideoInfo> values) {
      if (videoInfoListBuilder_ == null) {
        ensureVideoInfoListIsMutable();
     ...
     * <code>repeated .Vcloud.Models.Vod.VodVideoInfo VideoInfoList = 1;</code>
     */
    public VodVideoInfo.Builder getVideoInfoListBuilder(
        int index) {
     ...
     * <code>repeated .Vcloud.Models.Vod.VodVideoInfo VideoInfoList = 1;</code>
     */
    public VodVideoInfo.Builder addVideoInfoListBuilder() {
      return getVideoInfoListFieldBuilder().addBuilder(
          VodVideoInfo.getDefaultInstance());
    }
    /**
     * <pre>
     *视频信息列表
    ...
    public VodVideoInfo.Builder addVideoInfoListBuilder(
        int index) {
      return getVideoInfoListFieldBuilder().addBuilder(
          index, VodVideoInfo.getDefaultInstance());
    }
    /**
     * <pre>
     *视频信息列表
     ...
     * <code>repeated .Vcloud.Models.Vod.VodVideoInfo VideoInfoList = 1;</code>
     */
    public java.util.List<VodVideoInfo.Builder>
         getVideoInfoListBuilderList() {
      return getVideoInfoListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        VodVideoInfo, VodVideoInfo.Builder, VodVideoInfoOrBuilder>
        getVideoInfoListFieldBuilder() {
      if (videoInfoListBuilder_ == null) {
  ...
  private static final VodGetVideoInfosData DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new VodGetVideoInfosData();
  }

  public static VodGetVideoInfosData getDefaultInstance() {
