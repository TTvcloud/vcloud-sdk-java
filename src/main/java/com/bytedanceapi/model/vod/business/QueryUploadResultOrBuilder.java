...
public interface QueryUploadResultOrBuilder extends
   ...
   */
  java.util.List<com.bytedanceapi.model.vod.business.URLSet> 
      getVideoInfoListList();
  /**
   * <code>repeated .Vcloud.Models.Vod.URLSet VideoInfoList = 1;</code>
   */
  com.bytedanceapi.model.vod.business.URLSet getVideoInfoList(int index);
  /**
   * <code>repeated .Vcloud.Models.Vod.URLSet VideoInfoList = 1;</code>
   */
   ...
   * <code>repeated .Vcloud.Models.Vod.URLSet VideoInfoList = 1;</code>
   */
  java.util.List<? extends com.bytedanceapi.model.vod.business.URLSetOrBuilder> 
      getVideoInfoListOrBuilderList();
  /**
   * <code>repeated .Vcloud.Models.Vod.URLSet VideoInfoList = 1;</code>
   */
  com.bytedanceapi.model.vod.business.URLSetOrBuilder getVideoInfoListOrBuilder(
      int index);
