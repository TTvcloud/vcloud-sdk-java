...
public interface VodGetPlayInfoResultOrBuilder extends
   ...
   */
  com.bytedanceapi.model.vod.business.VodAdaptiveInfo getAdaptiveInfo();
  /**
   * <pre>
   * dash播放信息
   * </pre>
   ...
   * <code>.Vcloud.Models.Vod.VodAdaptiveInfo AdaptiveInfo = 8;</code>
   */
  com.bytedanceapi.model.vod.business.VodAdaptiveInfoOrBuilder getAdaptiveInfoOrBuilder();
   ...
   */
  java.util.List<com.bytedanceapi.model.vod.business.VodPlayInfo> 
      getPlayInfoListList();
  /**
   * <pre>
   *播放列表
   ...
   * <code>repeated .Vcloud.Models.Vod.VodPlayInfo PlayInfoList = 9;</code>
   */
  com.bytedanceapi.model.vod.business.VodPlayInfo getPlayInfoList(int index);
  /**
   * <pre>
   *播放列表
   * </pre>
   ...
   * <code>repeated .Vcloud.Models.Vod.VodPlayInfo PlayInfoList = 9;</code>
   */
  java.util.List<? extends com.bytedanceapi.model.vod.business.VodPlayInfoOrBuilder> 
   ...
   * <code>repeated .Vcloud.Models.Vod.VodPlayInfo PlayInfoList = 9;</code>
   */
  com.bytedanceapi.model.vod.business.VodPlayInfoOrBuilder getPlayInfoListOrBuilder(
      int index);
}
