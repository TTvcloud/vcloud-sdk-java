...
public interface VodGetRecPosterDataOrBuilder extends
   ...
   */
  java.util.List<VodStoreUriGroup>
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  VodStoreUriGroup getStoreUriGroups(int index);
  /**
   * <pre>
   *封面图信息
   * </pre>
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  java.util.List<? extends VodStoreUriGroupOrBuilder>
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  VodStoreUriGroupOrBuilder getStoreUriGroupsOrBuilder(
      int index);
