...
public interface VodGetRecPosterDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Vcloud.Models.Vod.VodGetRecPosterData)
   ...
   */
  java.util.List<com.bytedanceapi.model.vod.business.VodStoreUriGroup> 
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  com.bytedanceapi.model.vod.business.VodStoreUriGroup getStoreUriGroups(int index);
  /**
   * <pre>
   *封面图信息
   * </pre>
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  java.util.List<? extends com.bytedanceapi.model.vod.business.VodStoreUriGroupOrBuilder> 
   ...
   * <code>repeated .Vcloud.Models.Vod.VodStoreUriGroup StoreUriGroups = 1;</code>
   */
  com.bytedanceapi.model.vod.business.VodStoreUriGroupOrBuilder getStoreUriGroupsOrBuilder(
      int index);
