...
public class UpdateVideoPublishStatusDemo {
    public static void main(String[] args) {
        ...
        String vid1 = "your vid1";
        String vid2 = "your vid2";
        ...
        try {
            ...
            req1.setVid(vid2);
            req1.setStatus(Unpublished);

            VodUpdateVideoPublishStatusResponse resp1 = vodService.updateVideoPublishStatus(req.build());
